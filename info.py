...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', 'https://t.me/MOVIE_SEARCHING_GROUP_ACX'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', 'https://t.me/ACX_MOVIE_UPDATE')) # 
